...
This is a list of all the files in the `esp_data_aggregation` repo with dependencies on the NOAA-EDAB github.[^1] The dependencies within each file are printed below the file name.
...
out %>% 
  DT::datatable(rownames = FALSE,
                colnames = c("File name", "Content location"),
                extensions = 'Scroller',
