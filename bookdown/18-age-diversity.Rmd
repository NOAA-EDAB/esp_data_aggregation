...
}else print ("NOT ENOUGH DATA TO GENERATE METRIC")
...
fig<-selected.spp %>% 
  ...
  scale_fill_gradientn(colors = nmfspalette::nmfs_palette("regional web")(4),
                         name = "Year")+
  ggridges::geom_density_ridges2()+
  scale_x_continuous(limits = c(0,(max(selected.spp$AGE, na.rm = TRUE))), 
