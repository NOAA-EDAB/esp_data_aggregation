...
if(length(which(is.na(Selected_sp$total)))/length(Selected_sp$total)>0.40){ sp_data_qual<-FALSE}else{sp_data_qual<-TRUE}


if(length(which(is.na(selected_by_state$Pounds)))/length(selected_by_state$Pounds) >0.50){st_data_qual<-FALSE}else{st_data_qual<-TRUE}
