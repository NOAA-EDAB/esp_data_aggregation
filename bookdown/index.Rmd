...
dir.create(here::here(paste("docs/bookdown/", params$species, "/fig_cache/", sep = "")))
dir.create(here::here(paste("docs/bookdown/", params$species, "/cache/", sep = "")))

knitr::opts_chunk$set(echo = FALSE, message = FALSE, warning = FALSE, 
                      fig.width = 8, fig.align = 'center',
                      fig.path = here::here(paste("docs/bookdown/", 
                                                  params$species, "/fig_cache/", sep = "")),
                      cache.path = here::here(paste("docs/bookdown/", 
                                                  params$species, "/cache/", sep = "")))
