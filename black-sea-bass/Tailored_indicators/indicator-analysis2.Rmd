...
print(nrow(rpt_card_time))
print(ncol(rpt_card_time))
#for(i in 1:nrow(rpt_card_time)){
#  for(j in 1:ncol(rpt_card_time)){
#    print(i)
#    print(j)
   # print(rpt_card_time[i,])
  #  print(rpt_card_time[,j])
  #  print("high" %in% rpt_card_time[i,j])
  #  print(stringr::str_detect(rpt_card_time[i,j], "high"))
#    if(TRUE){
#      index[i,j] <- 1
#    } else {
#      index[i,j] <- 0
...
tab <- ggpubr::table_cell_bg(tab, row = index2[,1], column = index2[,2], linewidth = 5,
