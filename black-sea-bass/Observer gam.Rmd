...
#limit to 2011 as that is last year with abundant hauls
OB_selected<-OB_selected %>% filter(YEAR < 2012)
...
OB_selected %>%
  dplyr::group_by(YEAR) %>%
  dplyr::summarise(haul_per_yr=length(unique(LINK3)))%>%
...
# Family: Negative Binomial(0.516) 
# Link function: log 
# 
# Formula:
# HAILWT ~ s(YEAR, bs = "tp") + s(MONTH, bs = "cc") + 
#     te(LON.DD, LAT.DD, bs = "gp")
# 
# Parametric coefficients:
#             Estimate Std. Error z value Pr(>|z|)    
# (Intercept) 3.192519   0.008059   396.2   <2e-16 ***
# ---
# Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# 
# Approximate significance of smooth terms:
#                      edf Ref.df Chi.sq p-value    
# s(YEAR)            8.906      9   1905  <2e-16 ***
# s(MONTH)           7.794      8   1440  <2e-16 ***
# te(LON.DD,LAT.DD) 19.719     24   7904  <2e-16 ***
# ---
# Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# 
# R-sq.(adj) =  -2.92e+18   Deviance explained = 92.4%
# -REML = 1.2611e+05  Scale est. = 1         n = 30890
# > 

#biomass of comercial catch for BSB from last report 
