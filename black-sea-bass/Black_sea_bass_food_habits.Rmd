...
t11<- BSB_small %>% unite("ID",c(month, day, year,stratum,cruise6, tow, station, pdid),remove =FALSE)
t12<-t11 %>% filter(!analsci=="BLOWN")
t1<- BSB_small %>% unite("ID",c(cruise6, pdid,tow,stratum,station),remove =FALSE)
