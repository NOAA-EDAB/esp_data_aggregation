...
<!--chapter:end:geographic-distribution-a.Rmd-->
...
<!--chapter:end:length50maturity.Rmd-->
...
<!--chapter:end:age-diversity.Rmd-->

## Climate vulnerability

Climate vulnerability is sourced from Hare et al. (2016). The overall climate score for `r species` was `r NEesp::climate_risk[NEesp::climate_risk$Species == species, 2] %>% stringr::str_to_lower()` with `r NEesp::climate_risk[NEesp::climate_risk$Species == species, 3] %>% stringr::str_to_lower()` certainty.
...
if (params$file == "html") {
  NEesp::make_html_table(climate_data, col_names = cnames)
}

if (params$file == "word") {
  knitr::kable(climate_data, col.names = cnames)
}
```
