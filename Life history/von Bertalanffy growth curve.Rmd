...
```{r single growth curve,echo=FALSE, warning=FALSE, message=FALSE}
...
The parameter estimates for `r params$stock ` are Linf = `r f.fit.summary$parameters[1] ` K= `r f.fit.summary$parameters[2] `, and t0 = `r f.fit.summary$parameters[3] `
