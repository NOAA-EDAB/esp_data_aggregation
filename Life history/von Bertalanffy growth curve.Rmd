...
title: "von Bertalanffy growth curve for `r stringr::str_to_sentence(params$stock)`"
---
...
```{r data wrangeling, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE}
...
```{r single growth curve,echo=FALSE}
...
```{r small growth curves, echo=FALSE, eval=is_small}
...
```{r med growth curves, echo=FALSE, eval=is_med}
...
```{r large growth curves, echo=FALSE, eval=is_large}
