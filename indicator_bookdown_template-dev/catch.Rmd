...
if(params$file == "html") {
  NEesp::make_html_table(data, col_names = cnames)
}
...
cnames <- c("Year", "State", "Method", "Catch (lb)")
...
if (sum_test >= 2) {
  ...
  cnames <- colnames(all_catch)
  
  if(params$file == "html") {
    NEesp::make_html_table(all_catch, col_names = cnames)
  }
